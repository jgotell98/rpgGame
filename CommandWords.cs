...
namespace StarterGame
{
    public class CommandWords
    {
        ...
        private static Command[] commandArray = { new GoCommand(), new QuitCommand() , new StatsCommand(), new UseCommand(), new InventoryCommand(), new BuyCommand(), new SellCommand(), new CastCommand()};
